...
func GeneralSales2(w http.ResponseWriter, r *http.Request) {
	...
	lines, err := bob.All(
		...
		models.ItemSummaries.Query(
			...
			models.SelectWhere.ItemSummaries.DateOOrderDate.GTE(startDate),
			models.SelectWhere.ItemSummaries.DateOOrderDate.LTE(endDate),
